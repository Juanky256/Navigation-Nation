...
function toggleNav() {
    //Change menu icons when touched on
    menuBars.classList.toggle("change");
    //Remove the overlay
    overlay.classList.toggle("active-overlay");
    if (overlay.classList.contains("active-overlay")){
        //Adding class overlay-slide-right, which will move overlay to right
        overlay.classList.replace("overlay-slide-left", "overlay-slide-right");

        //Adding animation effects to navs
        ...
        //Adding class overlay-slide-left, which will move overlay to left
